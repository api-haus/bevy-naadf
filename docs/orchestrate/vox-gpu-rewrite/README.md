...
- [ ] Hard gate — user live-test post-Stage-11 binary; if visually clean, dispatch Stage 2 consolidation + file residual speckle as followup; if speckle is unacceptable, dispatch followup diagnostic  ← CURRENT
